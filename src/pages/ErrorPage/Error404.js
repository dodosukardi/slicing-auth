  ...
  return (
    <>
      <div className="w-96 rounded-[16px] border-2 border-neutral-100 shadow-sm flex flex-col p-8 mb-8 bg-white">
        ...
        <p className="text-center font-bold mb-6 text-red-800">ERROR 404</p>
        <p className="text-center mb-6 text-gray-800">Sorry, </p>

        <div className="relative flex py-5 items-center">
        <Button text="Back" type="primary" className="flex-1" onClick={() => true} />
        </div>
      </div>
    </>
  );
